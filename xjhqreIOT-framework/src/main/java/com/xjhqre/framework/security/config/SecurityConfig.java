package com.xjhqre.framework.security.config;
...
import com.xjhqre.framework.security.filter.JwtAuthenticationTokenFilter;
import com.xjhqre.framework.security.handle.AuthenticationEntryPointImpl;
import com.xjhqre.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
            ...
            .antMatchers("/admin/login", "/admin/register", "/captchaImage", "/sendEmail").anonymous()
            // 静态资源，可匿名访问
