...
// */
// @Override
// public ResponseEntity simpleMqttAuthentication(MqttAuthenticationModel mqttModel, ProductAuthenticateModel
// productModel) {
...
// } else {
// // 自动添加设备
// int result = deviceService.insertDeviceAuto(mqttModel.getDeviceNumber(), mqttModel.getUserId(),
// mqttModel.getProductId());
// if (result == 1) {
...
// */
// @Override
// public ResponseEntity encryptAuthentication(MqttAuthenticationModel mqttModel, ProductAuthenticateModel productModel)
// throws Exception {
// // 1=简单认证，2=加密认证，3=简单+加密认证
...
// * 授权码认证和处理
// */
// private String authCodeProcess(String authCode, MqttAuthenticationModel mqttModel, ProductAuthenticateModel
// productModel) {
// String message = "";
// if (authCode.equals("")) {
...
// }
// // 查询授权码是否存在
// ProductAuthorize authorize = productAuthorizeMapper.selectFirstAuthorizeByAuthorizeCode(new
// ProductAuthorize(authCode, productModel.getProductId()));
// if (authorize == null) {
