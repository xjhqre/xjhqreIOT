...
// import com.xjhqre.iot.service.CategoryService;
//
...
// startPage();
// return getDataTable(this.categoryService.selectCategoryList(category));
// }
//
// /**
// * 查询产品简短分类列表
...
// return AjaxResult.success(this.categoryService.selectCategoryShortList());
// }
//
// /**
// * 导出产品分类列表
...
// return AjaxResult.success(this.categoryService.selectCategoryByCategoryId(categoryId));
// }
//
// /**
// * 新增产品分类
...
// return toAjax(this.categoryService.insertCategory(category));
// }
//
// /**
// * 修改产品分类
...
// return toAjax(this.categoryService.updateCategory(category));
// }
//
// /**
// * 删除产品分类
...
// return this.categoryService.deleteCategoryByCategoryIds(categoryIds);
// }
// }
