...
// public ResponseEntity mqttAuth(@RequestParam String clientid, @RequestParam String username, @RequestParam String
...
// if(clientArray.length != 4 || clientArray[0].equals("") || clientArray[1].equals("") || clientArray[2].equals("") ||
// clientArray[3].equals("")){
// return toolService.returnUnauthorized(new MqttAuthenticationModel(clientid, username, password), "设备mqtt客户端Id格式为：认证类型
// & 设备编号 & 产品ID & 用户ID");
// }
...
// // 产品认证信息
// ProductAuthenticateModel model = deviceService.selectProductAuthenticate(new AuthenticateInputModel(deviceNumber,
// productId));
// if (model == null) {
// return toolService.returnUnauthorized(new MqttAuthenticationModel(clientid, username, password),
// "设备认证，通过产品ID查询不到信息");
...
// // 设备简单认证
// return toolService.simpleMqttAuthentication(new MqttAuthenticationModel(clientid, username, password, deviceNumber,
// productId, userId), model);
//
// } else if (authType.equals("E")) {
// // 设备加密认证
// return toolService.encryptAuthentication(new MqttAuthenticationModel(clientid, username, password, deviceNumber,
// productId, userId), model);
// } else {
