...
@Api(tags = "固件升级日志接口")
@RestController
@RequestMapping("/iot/otaUpgradeLog")
public class OtaUpgradeLogController extends BaseController {
    @Resource
    ...
    @GetMapping("/find")
    public R<IPage<OtaUpgradeLog>> find(OtaUpgradeLog otaUpgradeLog, @RequestParam Integer pageNum,
        @RequestParam Integer pageSize) {
        return R.success(this.otaUpgradeLogService.find(otaUpgradeLog, pageNum, pageSize));
    }
