...
import com.xjhqre.common.exception.TaskException.Code;
...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, DeviceJob job) throws SchedulerException, TaskException {
        ...
        JobDetail jobDetail = JobBuilder.newJob(QuartzJob.class).withIdentity(getJobKey(jobId, jobGroup)).build();
